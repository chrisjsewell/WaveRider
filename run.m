...
top = 400;
left = 420;
uicontrol('Parent',fig,'Style','text','Position',[left top-20 80 20],...
           'String','Initial Setup','BackgroundColor',bgcolor, 'FontWeight','bold')
% an editable text field to enter the intial gaussian wavefunction variance
uicontrol('Parent',fig,'Style','text','Position',[left top-180 50 20],...
                'String','Variance','BackgroundColor',bgcolor)
uicontrol('Parent',fig,'Style','edit',...
    'String',num2str(sys.init_var),'position',[left+60 top-180 40 20],...
...
label = slider_labels(fig,sys.t_step_bounds(1),sys.t_step_bounds(2),...
    sprintf('Time Step = %d',sys.t_step),left+20,top-70,100,50,bgcolor);
uicontrol('Parent',fig,'Style','slider',...
    'position',[left+20 top-70 100 50],...
...
label = slider_labels(fig,sys.x_step_bounds(1),sys.x_step_bounds(2),...
    sprintf('X Step = %2.2f',sys.x_step),left+20,top-130,100,50,bgcolor);
uicontrol('Parent',fig,'Style','slider',...
    'position',[left+20 top-130 100 50],...
...
uicontrol('Parent',fig,'Style','togglebutton',...
    'String','Propogate Sim','position',[left top-250 100 50],...
    'Callback',{@toggle_propogate,sys});% reset function wavefunction
uicontrol('Parent',fig,'Style','pushbutton',...
    'String','Reset Sim','position',[left top-300 100 50],...
